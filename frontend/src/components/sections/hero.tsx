...
export function HeroSection() {
  return (
    <article className="relative overflow-hidden bg-[var(--background)] text-[var(--foreground)] min-h-[80vh] flex items-center">
      {/* Background Effects */}
      ...
      <div className="layout-container relative z-10 space-y-8 pt-20 pb-20">
